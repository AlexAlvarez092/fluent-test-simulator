...
════════════════════════════════════════════════════════════════════════════════
  ...
  Tags: script include, sys_script_include, server-side, reusable logic, GlideAjax, client callable, Class.create, AbstractAjaxProcessor, module bridge, require, facade, legacy
════════════════════════════════════════════════════════════════════════════════
